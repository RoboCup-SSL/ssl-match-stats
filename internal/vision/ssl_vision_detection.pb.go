...
var file_ssl_vision_detection_proto_rawDesc = []byte{
	...
	0x6d, 0x61, 0x74, 0x63, 0x68, 0x2d, 0x73, 0x74, 0x61, 0x74, 0x73, 0x2f, 0x69, 0x6e, 0x74, 0x65,
...
func file_ssl_vision_detection_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_ssl_vision_detection_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_ssl_vision_detection_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_ssl_vision_detection_proto_msgTypes[2].Exporter = func(v any, i int) any {
